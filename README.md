...
* **Enables Internal Microphone:** Successfully initializes the DMIC (Digital Microphone) array on affected HP devices.

## 💻 Compatibility

* **Validated Hardware:** HP 255R G10
* **Technical Specifics:** Targets AMD Revision 62 of Board ID `15E2`.

## 🤝 Extending Support

This patch adds the HP 255R G10 to the driver's quirk table. If you have a similar AMD-based laptop with non-functional microphones, you can easily add your own Board ID to the quirks list following the pattern established in this patch.
